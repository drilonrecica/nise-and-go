...
var templateFiles = []templateFile{
	...
	{Template: "internal/app/backup.go.tmpl", Output: "internal/app/backup.go", Owner: OwnerApp},
	{Template: "internal/app/backup_test.go.tmpl", Output: "internal/app/backup_test.go", Owner: OwnerApp},
	...
	{Template: "internal/features/auth/budget_test.go.tmpl", Output: "internal/features/auth/budget_test.go", Owner: OwnerApp},
	...
	{Template: "internal/platform/config/backup.go.tmpl", Output: "internal/platform/config/backup.go", Owner: OwnerApp},
	...
	// The backup surface. pg_dump and pg_restore do the dump and the
	// restore; this package orchestrates them, seals what comes out, and
	// verifies a backup by restoring it rather than by checking a checksum.
	{Template: "internal/platform/backup/backup.go.tmpl", Output: "internal/platform/backup/backup.go", Owner: OwnerApp},
	{Template: "internal/platform/backup/crypt.go.tmpl", Output: "internal/platform/backup/crypt.go", Owner: OwnerApp},
	{Template: "internal/platform/backup/crypt_test.go.tmpl", Output: "internal/platform/backup/crypt_test.go", Owner: OwnerApp},
	{Template: "internal/platform/backup/file.go.tmpl", Output: "internal/platform/backup/file.go", Owner: OwnerApp},
	{Template: "internal/platform/backup/file_test.go.tmpl", Output: "internal/platform/backup/file_test.go", Owner: OwnerApp},
	{Template: "internal/platform/backup/operations.go.tmpl", Output: "internal/platform/backup/operations.go", Owner: OwnerApp},
	{Template: "internal/platform/backup/postgres.go.tmpl", Output: "internal/platform/backup/postgres.go", Owner: OwnerApp},
	{Template: "internal/platform/backup/postgres_test.go.tmpl", Output: "internal/platform/backup/postgres_test.go", Owner: OwnerApp},
