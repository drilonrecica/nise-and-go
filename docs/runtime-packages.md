...
| `runtime/session` | Opaque session tokens, their stored digests, the idle/absolute/revoked lifecycle rules, the freshness window a reauthentication satisfies, and the browser cookie policy. | implemented | M5-001, M5-015, M5-013 |
